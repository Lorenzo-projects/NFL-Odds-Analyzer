...
- **Consensus Tracking**: Calculates bookmaker consensus and implied probabilities
...
- Implied Probability: Calculated from aggregated odds
...
- CORS proxy handling for API requests
- Modular architecture with separate concerns:
  - Odds analysis engine
